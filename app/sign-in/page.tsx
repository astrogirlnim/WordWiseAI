            ...
            <Dialog>
              ...
              <DialogContent className="sm:max-w-md">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Sign in to your FunnelFluent AI account
                  </DialogDescription>
                </DialogHeader>
          ...
          <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mb-8 text-xl text-muted-foreground sm:text-2xl lg:max-w-3xl lg:mx-auto">
                ...
                intelligent suggestions and seamless document sharing.
              </p>
              ...
              <Card className="relative overflow-hidden border-border/50 bg-card/50 backdrop-blur-sm">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    AI suggestions tailored specifically for sales funnel content and marketing copy.
                  </p>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center gap-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-retro-primary" />
                      Sales-specific language improvements
                    </li>
                    <li className="flex items-center gap-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-retro-primary" />
              ...
              <Card className="relative overflow-hidden border-border/50 bg-card/50 backdrop-blur-sm">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <CardTitle className="text-lg">Document Version Control</CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    Track changes over time with comprehensive version control for your funnel documents.
                  </p>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center gap-2">
              ...
              <Card className="relative overflow-hidden border-border/50 bg-card/50 backdrop-blur-sm">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <CardTitle className="text-lg">Dynamic Document Sharing</CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    Share your sales funnel documents instantly with secure dynamic links for team collaboration.
                  </p>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center gap-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-retro-cyan" />
                      Instant secure sharing links
                    </li>
                    <li className="flex items-center gap-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-retro-cyan" />
              ...
              <Card className="relative overflow-hidden border-border/50 bg-card/50 backdrop-blur-sm">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <CardTitle className="text-lg">Writing Optimization</CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    Get intelligent suggestions to improve your sales copy&apos;s clarity and impact.
                  </p>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center gap-2">
        ...
        <section className="py-20 lg:py-32 bg-muted/30">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">
                Whether you&apos;re creating individual sales documents or collaborating on team campaigns, FunnelFluent AI streamlines your writing process.
              </p>
            </div>
            ...
            <div className="grid gap-8 sm:grid-cols-3">
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Collaborate on sales funnel documentation with dynamic sharing and version control. 
        ...
        <section className="py-20 lg:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">
                From landing pages to email sequences, FunnelFluent AI helps you create professional sales documentation.
              </p>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Start creating professional sales content with AI-powered writing assistance and seamless document sharing.
              </p>
